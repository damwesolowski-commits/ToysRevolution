...
public class GrayButton : ButtonBase
{
    ...
    private IEnumerator RegisterDelayed()
    {
        ...
        GrayButtonGroupManager.RegisterButton(this);
        //Debug.Log($"[GrayButton] ✅ Zarejestrowano przycisk GroupID={groupId}, requiredPlayers={requiredPlayers}");
    }
    ...
    protected override void OnPressed(GameObject unit)
    {
        ...
        {
            isPressed = true;
            GrayButtonGroupManager.NotifyButtonPressed(groupId, this);
        }
    }
    ...
    protected override void OnReleased(GameObject unit)
    {
        ...
        {
            isPressed = false;
            GrayButtonGroupManager.NotifyButtonReleased(groupId, this);
        }
    }
